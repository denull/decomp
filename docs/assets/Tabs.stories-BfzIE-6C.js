import{n as e}from"./chunk-BneVvdWh.js";import{A as t,E as n,G as r,J as i,K as a,O as o,V as s,W as c,Y as l,nt as u,st as d,t as f,tt as p,ut as m,z as h}from"./client-kmAv9JMI.js";import{i as g,n as _,r as v,t as y}from"./create-runtime-stories-q1XJjIxV.js";import{n as b,t as x}from"./Tabs-BigTJJdE.js";function S(e,t){u(t,!0);var l=A(),f=r(l);w(f,{name:`String Tabs`,template:e=>{x(e,{tabs:[`Overview`,`Activity`,`Settings`],get value(){return h(T)},set value(e){i(T,e,!0)},children:(e,t)=>{var r=E(),i=a(c(r)),l=c(i,!0);d(i),d(r),s(()=>n(l,h(T))),o(e,r)},$$slots:{default:!0}})},$$slots:{template:!0},parameters:{__svelteCsf:{rawCode:`<Tabs tabs={['Overview', 'Activity', 'Settings']} bind:value={selected}>
